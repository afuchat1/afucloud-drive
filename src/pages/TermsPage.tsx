    ...
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-foreground">
        <section>
          ...
          <p>By accessing or using AfuCloud ("Service"), operated at cloud.afuchat.com, you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.</p>
        </section>
        ...
        <section>
          ...
          <p>Your use of the Service is also governed by our <Link to="/privacy" className="text-brand hover:underline">Privacy Policy</Link>. We do not sell your data to third parties.</p>
        </section>
        ...
        <section>
          ...
          <p>For questions about these terms, contact us at <a href="mailto:support@afuchat.com" className="text-brand hover:underline">support@afuchat.com</a>.</p>
        </section>
      </div>
    </main>
